    ...
    <ul className='flex gap-2 flex-wrap items-center justify-center'>
      {skills.map(skill => (
        <li key={skill.id} className='flex flex-col items-center md:grayscale ease-in-out duration-200 hover:scale-110 hover:grayscale-0'>
          <article className='border-[1px] dark:border-slate-400 dark:bg-slate-900 border-blue-400 bg-blue-900 shadow-sm shadow-blue-700 dark:bg-opacity-40 bg-opacity-20 duration-200 ease-in-out hover:bg-opacity-80 rounded-full w-fit p-4'>
