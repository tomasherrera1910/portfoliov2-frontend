...
export function Contact (): JSX.Element {
  ...
  return (
      <section className='flex flex-col sm:flex-row my-8 sm:justify-center'>
        ...
        <aside className='text-slate-200 font-roboto font-medium bg-gradient-to-b from-slate-900 via-sky-900 to-sky-800 bg-opacity-20 max-w-sm flex items-center justify-around flex-wrap p-1 gap-2 rounded-bl-md sm:flex-col sm:px-2 sm:bg-gradient-to-r sm:rounded-bl-none sm:rounded-tr-md'>
          <ContactInfo/>
        </aside>
      </section>
  )
