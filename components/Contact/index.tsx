...
export function Contact (): JSX.Element {
  ...
  return (
      <section className='flex flex-col my-8'>
        <form className='bg-black bg-opacity-40 rounded-tr-md p-2'>
        ...
        <aside className='text-slate-200 font-bold bg-gradient-to-b from-slate-900 via-sky-900 to-sky-800 bg-opacity-20 flex justify-around flex-wrap p-1 gap-2 rounded-bl-md'>
          <ContactInfo/>
        </aside>
      </section>
  )
