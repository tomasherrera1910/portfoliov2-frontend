...
export default function ProjectsFilter ({ skills, filterToggle, resetFilters, results, filters }: Props): JSX.Element {
  ...
  return (
    <>
      ...
      <aside className={`flex z-10 flex-col self-start min-h-full gap-1 bg-black bg-opacity-80 p-1 rounded fixed ease-in-out duration-200 top-0 ${menuFiltersPosition} lg:relative lg:left-0`}>
